...
/*  js-model JavaScript library, version 0.8.3
 *  (c) 2010 Ben Pickles
 *
...
// Helpers are available in your controllers and your views
...
var app = $.sammy(function() {
	...
	this.use(Sammy.Template);
	this.use(Sammy.NestedParams);
	this.use(Sammy.SmartRenderer, '/javascripts/choco_app/app/views/');
